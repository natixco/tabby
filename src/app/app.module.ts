...
@NgModule({
  declarations: [AppComponent, SidebarComponent, SettingsComponent, TimetableComponent, TasksComponent, NewLessonComponent, EditLessonComponent, ContextmenuComponent, HoldDeleteDirective],
  imports: [
    BrowserModule,
    ReactiveFormsModule,
    HttpClientModule,
